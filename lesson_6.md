...
2. Также структура Interval добавляется вместо свойства Damage у Unit. При этом минимальное значение должно быть равно 0. Добавьте ещё один конструктор с доп. параметрами типа int для мин. и макс. значений урона.
